...
public:
    ...
    static s32 mDisplayVersion;
    static EffectSystem instance;
    static DrawInfo mSortEffectOperatorZDrawInfo;
public:
    ...
    void SetProcessCamera(const math::VEC3& rPos, const math::MTX34& rMtx, f32 near, f32 far);
