...
public:
    enum InheritFlag {
        ...
        INHERIT_FLAG_UNK_2 = (1 << 2),
        INHERIT_FLAG_UNK_5 = (1 << 5),
    };
...
public:
    ...
    virtual Emitter* CreateEmitter(EmitterResource* pResource,
                                   ...
                                   Particle* pParticle,
                                   u16 calcRemain, math::VEC3* pTranslationVec); // at 0x14
    ...
    bool CreateEmitterTmp(EmitterResource* pResource,
                          EmitterInheritSetting* pSetting, Particle* pParticle,
                          u16 calcRemain, math::VEC3* pTranslationVec);
