...
config.libs = [
    ...
    },
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "donut/file/FileAccessor.cpp", extra_cflags=["-O3,s"]),
            ...
            Object(NonMatching, "donut/file/FileManager.cpp", extra_cflags=["-O3,s"]),
    ...
    },
    {
        ...
        "progress_category": "donut",
        "objects": [
            Object(NonMatching, "donut/font/Font.cpp", extra_cflags=["-O3,s"]),
            Object(NonMatching, "donut/font/FontKindUtil.cpp", extra_cflags=["-O3,s"]),
            Object(NonMatching, "donut/font/FontLoader.cpp", extra_cflags=["-O3,s"]),
